function [xp,xm,Pp,Pm,Qp,Qm] = sbp_staggered_strong(order,n,h,truncate,test)
% [xp,xm,Pp,Pm,Qp,Qm] = sbp_staggered_strong(order,n,h,truncate,test)
%
% Input:
...
% Qp, Qm             : Operators that satisfy SBP property Qp + Qm^T = B
 ...
 switch order
   case 2
     [xp,xm,Pp,Pm,Qp,Qm] = sbp_staggered_strong_2nd(n,h,test);
   case 4
     [xp,xm,Pp,Pm,Qp,Qm] = sbp_staggered_strong_4th(n,h,test);
   case 6
     [xp,xm,Pp,Pm,Qp,Qm] = sbp_staggered_strong_6th(n,h,test);
   case 8
     [xp,xm,Pp,Pm,Qp,Qm] = sbp_staggered_strong_8th(n,h,test);
   otherwise
