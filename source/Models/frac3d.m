classdef frac3d
    ...
    properties
        ...
        Ae;             % the part of A that treated explicitly, do not include A12, A13.
    ...
    methods
       ...
       function obj = update(obj,U)
        ...
        function [Ae, Ai] = discretization(obj)
            ...
            % Wave propagation
            % These two terms in explict part are addressed separatly from other
            % parts to avoid assemble huge dense matrix A12 and A13.
            
            % The update contributed by these two parts are added later by
            % first reduce vx and vy into ux and uy and then multiply with
            % Dx2 and Dy2 and finally with K_t  (K_t is quite dense!!!!!!!!!)
